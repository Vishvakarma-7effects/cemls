                    ...
                    <div class="card box">
                        <div class="card-body">
                            <header class="section-heading mb-3">
                                <h4 class="title-section float-left">Edit Package</h4>
                            ...
                            <div class="row mb-3 pl-2 pr-2">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{$package->name}}" required="required" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="required">Monthly Price</label>
                                        <input type="number" name="mPrice" value="{{$package->mPrice}}" required="required" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="required">Annual Price</label>
                                        <input type="number" name="aPrice" value="{{$package->aPrice}}" required="required" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="required">Features</label>
                                        <input type="text" name="features"  value="{{$package->features}}" data-role="tagsinput" required="required" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="required">Allowed No. Of Events</label>
                                        <input type="number" name="allowedEvent" value="{{$package->allowedEvent}}" required="required" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
