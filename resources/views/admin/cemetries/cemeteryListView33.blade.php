        ...
        <div class="modal-dialog mCustomScrollbar" role="document">
          <div class="modal-content">
            ...
            <div class="clearfix pphead">
              <ul class="ulshare">
                <li><a href="{{ url('cemetery/cemeteryDetailPage')}}">
                    <!--<i class="far fa-heart"></i> Save</a>--></li>
...
<script src="https://maps.google.com/maps/api/js?key=AIzaSyDAS521f0zqxuZ8zKvF7j7YkO-JbKwkDVs"></script>
