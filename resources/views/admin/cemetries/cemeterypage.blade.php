...
<link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous">
      ...
      <div id="slider1_container"
        ...
        <div u="slides"
          ...
          @foreach($cemetery as $key=>$cem)
          <div>
            <img u="image" src="{{ url('public/uploads/'.$cem->cemeteryimage) }}" />
            <img u="thumb" src="{{ url('public/uploads/'.$cem->cemeteryimage) }}" />
          </div>
         @endforeach
        </div>
        <!-- Arrow Left -->
        ...
        <div class="col-lg-8">
          <div class="ppinner">
            <div class="mdtlp clearfix">
              <div class="mdtlp_lft">
                                  <address>CemLS #{{$singlcemetry->id}}</address>

                <h2 class="mdtlphead">{{$singlcemetry->cemetery_name}}</h2>
                <address>{{$singlcemetry->city}}{{$singlcemetry->state}}</address>
              </div>
              <div class="mdtlp_rht">
                <div class="pricebx"><bdi>Price</bdi><sup>$</sup> {{$singlcemetry->price}} <span>Onwards</span></div>
              </div>
            </div>
            <p>{{$singlcemetry->cemetery_desc}}</p>
