						...
						<div class="col-lg-9 pr-lg-0">
							<div class="form-group row">
								...
								<div class="col-lg-7 col-sm-9 pl-3 pl-md-4">
									<input type="text" class="form-control" name="cemetery_name" value="{{ $cemeterys->cemetery_name }}" id=""
										placeholder="">
								</div>
							</div>
										...
										<div class="col-md-6 col-sm-9 pl-3 pl-md-4 ">
											...
											<select name="countries_id" id="countries_id" class="form-control" data-control="select2">
												...
												@foreach ($countries as $row)
													<option value="{{ $row->id }}" {{ $cemeterys->countries_id == $row->id ? 'selected' : '' }}>
														<b>{{ $row->countries }}</b></option>
												@endforeach
											</select>
										...
										<div class="col-sm-9 pl-3 pl-md-4 ">
											<select name="state" id="state_select" class="form-control" data-control="select2">
												...
												@foreach ($states as $row)
													<option value="{{ $row->id }}" {{ $cemeterys->state == $row->id ? 'selected' : '' }}>
														<b>{{ $row->state }}</b></option>
												@endforeach
											</select>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-md-7">
									<div class="form-group row">
										...
										<div class="col-md-6 col-sm-9 pl-3 pl-md-4 ">
											<input data-id="userstatus" value="1" name="status"
												class="form-control radio userstatus btn_lg btn_green my-lg-3 mx-md-2 mx-lg-0" id="userstatus"
												type="checkbox" data-toggle="toggle" data-on="Active" {{ $cemeterys->imagestatus == 1 ? 'checked' : '' }}
												data-off="Inactive" data-size="small" data-onstyle="primary">
										</div>
									</div>
								</div>
				...
				<div class="cntbox">
					<div class="row">
						<div class="col-lg-6 mb-3">
							<div class="loc_search position-relative">
								<input type="text" name="location" value="{{ $cemeterys->location }}" class="form-control" id="pac-input"
						...
						<div class="col-lg-6 mb-1 mb-md-3 loctxt d-flex justify-content-center align-items-end">
							<b>Latitude: </b> <span id='latbox'>{{ $cemeterys->cemetery_latitude }}</span><span
								class="d-inline-block pl-3"><b>Longitude: </b> <span
									id='lngbox'>{{ $cemeterys->cemetery_longitude }}</span></span>
						</div>
					</div>
					...
					<div class="mframe mb-4 pb-1">
						...
						<iframe class="gmap_iframe" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
							src="https://maps.google.com/maps?width=900&amp;height=400&amp;hl=en&amp;q=<?php echo $cemeterys->location; ?> &amp; t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed&amp;maptype=satellite"
							height="400px" width="900px"></iframe>
					</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-7 infosec">
									<input type="text" class="form-control" name="locationtitle1" id="" placeholder=""
										value="{{ $cemeterys->locationtitle1 }}">
									<div class="infobx"><i class="fa fa-info" data-toggle="tooltip" data-placement="top"
											title="Tooltip on top"></i></div>
								</div>
							...
							<div class="form-group position-relative row">
								...
								<div class="col-sm-7 infosec pl-lg-0">
									<input type="text" class="form-control" name="locationtitle2" id="" placeholder=""
										value="{{ $cemeterys->locationtitle2 }}">
									<div class="infobx"><i class="fa fa-info" data-toggle="tooltip" data-placement="top"
											title="Tooltip on top"></i></div>
								</div>
							...
							<div class="form-group position-relative row">
								...
								<div class="col-sm-7 infosec">
									<input type="text" class="form-control" name="locationtitle3" id="" placeholder=""
										value="{{ $cemeterys->locationtitle3 }}">
									<div class="infobx"><i class="fa fa-info" data-toggle="tooltip" data-placement="top"
											title="Tooltip on top"></i></div>
								</div>
							...
							<div class="form-group position-relative row">
								...
								<div class="col-sm-7 pl-lg-0 infosec">
									<input type="text" class="form-control" name="locationtitle4" id="" placeholder=""
										value="{{ $cemeterys->locationtitle4 }}">
									<div class="infobx"><i class="fa fa-info" data-toggle="tooltip" data-placement="top"
											title="Tooltip on top"></i></div>
								</div>
							</div>
							...
							<div class="form-group position-relative row">
								...
								<div class="col-sm-7 infosec">
									<input type="text" class="form-control" name="locationtitle5" id="" placeholder=""
										value="{{ $cemeterys->locationtitle5 }}">
									<div class="infobx"><i class="fa fa-info" data-toggle="tooltip" data-placement="top"
											title="Tooltip on top"></i></div>
								</div>
							...
							<div class="form-group position-relative row">
								...
								<div class="col-sm-7 infosec pl-lg-0">
									<input type="text" class="form-control" name="locationtitle6" id="" placeholder=""
										value="{{ $cemeterys->locationtitle6 }}">
									<div class="infobx"><i class="fa fa-info" data-toggle="tooltip" data-placement="top"
											title="Tooltip on top"></i></div>
								</div>
                    ...
                    foreach($cemeterygallery as $galleryimage)
                    {
                            ...
                            ?>
													<td width="76" style="padding: 4px;">
														<a href="#" class="btn btn-sm btn-outline-danger py-0 deleteplot" style="font-size: 0.8em;"
															id="deleteMovie" data-id="{{ $galleryimage->id }}">
															<i class="fa fa-trash-can" aria-hidden="true"></i>
														</a>


														<img src="{{ asset('/uploads/cemeterygallery/' . $galleryimage->cemeteryimage) }}"
															class="plot_img" />
													</td>
