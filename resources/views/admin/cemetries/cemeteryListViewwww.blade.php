                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <input type="text" class="form-control" id="keyword" name="keyword" placeholder="Address, City or ZIP" value="<?php echo (isset($_REQUEST['keyword'])) ?  $_REQUEST['keyword'] : '';?>">
                                </div>
                            </div>
...
$(document).ready(function($) {
    ...
    function createSideBarResult(){
        ...
        for( i = 0; i < visibleMarkersOnMap.length; i++ ){
            ...
            resultsHtml.push(
                '<div class="col-lg-6 col-md-6 col-sm-6 col-6 plr-4" data-ts-id="' + loadedMarkersData[id]["id"] + '" data-ts-ln="' + newMarkers[id].loopNumber + '">' +
                    '<a href="https://new.cemeterylistingservice.com/cemetery/cemeteryListDetails" class="">' +
                        '<div class="boxinner">'+ 
                  '<span class="tagtxt">Outdoor</span>'+ 
                  ...
                  '</div>' +
                  '<div class="boxinnercnt">' +
                   ' <h2 class="bxhead mt-0">'+ loadedMarkersData[id]["cemetery_name"]+'</h2>' +
                   ' <address class="bxaddress mb-0">'+ loadedMarkersData[id]["address"]+'</address>' +
                  '</div>' +
                  '<div class="bxprice"><sup>$</sup> 3249 <span>Onwards</span></div>' +
                '</div>'+
        ...
        $("#ts-results .row").html(resultsHtml);
