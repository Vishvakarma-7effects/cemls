      ...
      <div class="col-sm-7  pl-4 pl-md-4 ">
       <div class="row">
        ...
        <div class="col-lg-6 col-6">
         <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="status" id="exampleRadios1" value="blocked" checked>
          <label class="form-check-label" for="exampleRadios1">
           Blocked
          </label>
         </div>
      ...
      <div class="col-sm-7 pl-3 pl-md-4 d-flex justify-content-between">
       <div class="row">
        @foreach ($roles as $item)
         <div class="col-lg-6 col-6">
         <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="roles" value="{{$item->name}}">
