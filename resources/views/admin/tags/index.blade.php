	...
	<section class="panelrht">
		...
		<div class="row mb-3">
			<div class="col-md-5 col-6">
				<h1 class="mheading">All Tags</h1>
			</div>
			<div class="col-md-7 col-6 text-right"><a href="{{ url('tag/create') }}" class="btn_mid btn_green">Add Tag</a>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<ul class="nav nav-tabs same_tabs clearfix" id="userTab" role="tablist">
					...
					<li class="nav-item">
						<a class="nav-link" id="public-tab" data-toggle="tab" href="{{ url('tag') }}" role="tab"
							aria-controls="Public" aria-selected="true">All Tags</a>
					</li>
			...
			<div class="col-lg-4">
				...
				<form action="{{ route('tag.index') }}" method="GET" role="search">

					<div class="searchbx w-100 mb-2 mt-2 mb-lg-0 mt-lg-0 position-relative">
						<input type="text" class="form-control" name="term" id="" placeholder="Search by tag">
											...
											<td>
												<div class="moption">
													...
													<ul class="moptionul">
														...
														<li><a href="{{ url('tag/edit/' . $listing->id) }}">Edit</a></li>
														<li><a href="{{ url('tag/delete/' . $listing->id) }}" onclick="confirm('Want to delete tag?');">Delete</a></li>
													</ul>
												</div>
											</td>
										</tr>
