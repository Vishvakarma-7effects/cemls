			...
			<div id="myTabContent" class="tab-content">
				<div class="tab-pane fade show active" id="burials" role="tabpanel" aria-labelledby="burials-tab">
                   ...
                   if(!empty($plotgallery[0]->plotimage)) {  ?>
										...
										<img src="{{ asset('/uploads/plotgallery/' . $plotgallery[0]->plotimage) }}"
											class="plot_img" />
										<?php } else { ?>
									...
									<td width="450px">
										...
										<div class="plotshead">
											...
											<?php
												...
												if (!empty($cemeteryname[0]->cemetery_name)) {
																echo $cemeteryname[0]->cemetery_name;
												}
												?>
										</div>
									...
									<td style="padding: 15px;">
										...
										<div class="d-flex">
											<input data-id="{{ $row->id }}" class="radio" type="checkbox"
												data-toggle="toggle" data-on="Yes" {{ $row->feature == 1 ? 'checked' :'' }} data-off="No" data-size="small"
