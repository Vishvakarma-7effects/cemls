...
<section class="panelrht">
 ...
 <h1 class="mheading">Add Location</h1>
 <form method="post" action="{{route('location.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">
        @csrf
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-12 pr-lg-4">
     <div class="form-group row">
      ...
      <div class="col-sm-8 pl-3 pl-md-4">
       <input type="text" class="form-control" name="location_title" id="" placeholder="" required>
      </div>
     </div>
    </div>
