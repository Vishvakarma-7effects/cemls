				...
				<div id="myTabContent" class="tab-content">
                   ...
                   if(!empty($cemeterygallery[0]->cemeteryimage)) {  ?>
											...
											<td style="padding: 15px;">
												...
												<div class="d-flex">
													<input data-id="{{ $cemVal->id }}" class="public" type="checkbox" data-toggle="toggle"
														data-on="Yes" {{ $cemVal->public == 1 ? 'checked' : '' }} data-off="No" data-size="small"
											...
											<td width="350px" style="padding: 15px;">
												...
												<div class="d-flex">
													<a class="btn_mid btn_cms_list mr-3"
														href="{{ route('users.index', ['cemetery_id' => $cemVal->id]) }}">Manage Members</a>
											...
											<td width="40" align="right" style="padding: 15px;">
												<div class="moption  mt-4">
													...
													<ul class="moptionul">
														...
														<li><a href="{{ url('cemeteries/' . $cemVal->id . '/edit') }}">Edit</a>
                                                        </li>
