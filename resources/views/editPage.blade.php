                                            ...
                                            <div id="page_translations_en_a2lix_translations-fields" class="tab-pane show active" role="tabpanel">
                                                <div id="page_translations_en">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="page_translations_en_title" name="title" required="required" maxlength="35" class="form-control" value="{{$page->title}}" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="page_translations_en_content">Content</label>
                                                        <textarea id="page_translations_en_content" name="content" class="htmlEditor form-control">{{$page->content}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
