...
<section class="section-pagetop bg-gray">
    <div class="container clearfix">
        <h4 class="title-page dark b float-xl-left mb-0">Role</h4>
                ...
                <div class="box shadow-none bg-gray mb-4">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-6 text-center text-lg-left mb-3 mb-lg-0">
                            <span class="center-lg-y text-muted">{{count($roles)}} result(s) found</span>
                        </div>

                        <div class="col-sm-12 col-lg-6 text-center text-lg-right">
                            <a href="{{url('role/create')}}" class="btn btn-primary ml-3" data-toggle="tooltip" title="Add a new page"><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="display: flex;justify-content: space-around;">
                                                ...
                                                <a class="btn btn-sm btn-success" href="{{url('role/assign/'.$role->id)}}">Assign</a>
