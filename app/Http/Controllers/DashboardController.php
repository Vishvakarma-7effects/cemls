...
// .......
           ...
           $geo =   DB::table('geo')
            ...
            // dd($recentPlot);
            return view('admin.dashboard',compact('recentMyListings','recentPlotlists','mail','recentPlot','recentmsg', 'cemeterys','cemeteryscount','mailcount', 'plots','plotscount','geo'));
